...
export const MESSAGE_ATTACHMENT_DOCUMENT_WIDTH_PX = MESSAGE_ATTACHMENT_DRAFT_IMAGE_SIZE_PX * 4
export const MESSAGE_ATTACHMENT_AUDIO_WIDTH_PX = MESSAGE_ATTACHMENT_DRAFT_IMAGE_SIZE_PX * 4
