          ...
          <div className="admin-panel-content__data">
            <div className="admin-panel-content__header">
              ...
              <div className="admin-panel-content__actions">
                <AppButton
                  text="Refresh"
                  additionalClassName="refresh-btn admin-panel-content__btn"
                  onClick={getData}
                />
                <AppButton
                  text="DB Сlear"
                  additionalClassName="db-reset-btn admin-panel-content__btn"
                  onClick={dbClearLoaderHandler}
                />
                <AppButton
                  text="Apply basic fixtures"
                  additionalClassName="apply-base-fixtures-btn admin-panel-content__btn"
              ...
              {dbElements.map((el) => (
                <div
                  ...
                  className={`paragraph-text pointer admin-panel-content__header-element ${
                    selectedAdminPanelModelTab === el.value ? 'paragraph-text--accent' : ''
                  }`}
                  onClick={() =>
