...
export const AdditionalServiceContext = createContext<{ [key: string]: React.MutableRefObject<any> }>({})

interface ServiceProviderProps {
  children: ReactNode
}

export const AdditionalServiceProvider: React.FC<ServiceProviderProps> = ({ children }: ServiceProviderProps) => {
