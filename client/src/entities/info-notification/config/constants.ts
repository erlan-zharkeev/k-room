import type { IInfoNotificationItem } from 'src/entities/info-notification'
import { WelcomeInfoNotification, INFO_NOTIFICATIONS_I18N } from 'src/entities/info-notification'
