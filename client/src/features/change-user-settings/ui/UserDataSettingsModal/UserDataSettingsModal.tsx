...
import { IUserData, UserEndpointsEnum } from 'common-types'
import { useState, useEffect } from 'react'
import { useDispatch } from 'react-redux'
import { useTypedSelector, useValidate } from 'src/shared/lib'
import { useApi } from 'src/shared/api'
import { AppAvatarLoader, AppInput, AppButton, AppForm } from 'src/shared/ui'
...
export const UserDataSettingsModal = () => {
  ...
  const onFinish = async (values: IUserData) => {
    ...
    setIsLoading(true)
    const response = await doRequest('post', UserEndpointsEnum.UpdateUserData, updatedUserData, 'multipart/form-data')
  ...
  return (
    <div className="user-data-settings-modal">
      <AppForm
