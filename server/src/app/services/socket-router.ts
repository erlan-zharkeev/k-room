import { socketCallRouter } from 'features/call'
...
const featureRouters = [socketUserRouter, socketChatRoomRouter, socketContactRouter, socketMessageRouter, socketCallRouter]
