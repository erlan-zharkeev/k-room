...
export type EndpointsType =
  | ValueOf<typeof import('../../endpoints/config').AUTH_ENDPOINTS>
  | ValueOf<typeof import('../../endpoints/config').USER_ENDPOINTS>
  | ValueOf<typeof import('../../endpoints/config').CODES_ENDPOINTS>
  | ValueOf<typeof import('../../endpoints/config').ADMIN_ENDPOINTS>
  | ValueOf<typeof import('../../endpoints/config').MEDIA_ENDPOINTS>
