...
export type EndpointsType = ValueOf<typeof import('./constants').AUTH_ENDPOINTS> | ValueOf<typeof import('./constants').USER_ENDPOINTS> | ValueOf<typeof import('./constants').CODES_ENDPOINTS> | ValueOf<typeof import('./constants').ADMIN_ENDPOINTS> | ValueOf<typeof import('./constants').MEDIA_ENDPOINTS>;
export {};
