import { useSystem } from 'src/shared/system/hooks/use-system'
import { MIN_SUPPORTED_HEIGHT, MIN_SUPPORTED_WIDTH } from 'src/shared/system/internals/constants'
import { VIEW_PORT_WIDTH } from 'src/shared/system/internals/types'
