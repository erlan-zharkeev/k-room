import { useThemeUpdate } from 'src/features/update-theme/model/use-theme-update'
import { THEME_SWITCHER_I18N } from 'src/features/update-theme/ui/ThemeSwitcher/internals/i18n'
